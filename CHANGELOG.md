...
built artifacts: the wheel holds 95 modules plus the packaged command assets and metadata; the sdist adds
...
**95 of the 95 shipped modules import.** None fail. (The figure read 73 of 73 when `0.1.0` was
