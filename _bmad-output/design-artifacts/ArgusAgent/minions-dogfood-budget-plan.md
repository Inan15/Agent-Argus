...
- **V1 deterministic total: 455 credits**
- **Headroom (5/4): +113 credits**
- **Sized ceiling `$X`: 568 credits** (int — never a float, AR4)
- Build-cost proxy (total physical LOC): 31413
...
|---|---|---|---|---|
| `89d20327e4ec` | 1 | 1 | 5 | True |
| `b393cc33ad36` | 21 | 21 | 105 | True |
| `cde742d4b2bb` | 33 | 33 | 165 | True |
| `ea9eacb84715` | 36 | 36 | 180 | True |

## 3.2 halt demonstration (the ceiling halts + downgrades if breached)

- Under `BudgetConfig(ceiling_credits=568)` the run FITS (`ceiling_reached is False`): **True**
