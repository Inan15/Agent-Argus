...
- **V1 deterministic total: 460 credits**
- **Headroom (5/4): +115 credits**
- **Sized ceiling `$X`: 575 credits** (int — never a float, AR4)
- Build-cost proxy (total physical LOC): 32085
...
| `eaea59c07379` | 33 | 33 | 165 | True |
| `fcadcb535df6` | 2 | 2 | 10 | True |

## 3.2 halt demonstration (the ceiling halts + downgrades if breached)

- Under `BudgetConfig(ceiling_credits=575)` the run FITS (`ceiling_reached is False`): **True**
