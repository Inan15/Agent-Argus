...
- **V1 deterministic total: 465 credits**
- **Headroom (5/4): +116 credits**
- **Sized ceiling `$X`: 581 credits** (int — never a float, AR4)
- Build-cost proxy (total physical LOC): 32140
...
|---|---|---|---|---|
| `5d61dafe2e8f` | 34 | 34 | 170 | True |
| `66504ab3bb22` | 36 | 36 | 180 | True |
| `b393cc33ad36` | 21 | 21 | 105 | True |
| `fcadcb535df6` | 2 | 2 | 10 | True |

## 3.2 halt demonstration (the ceiling halts + downgrades if breached)

- Under `BudgetConfig(ceiling_credits=581)` the run FITS (`ceiling_reached is False`): **True**
